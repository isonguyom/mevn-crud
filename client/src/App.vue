<template>
  <main>
    ...
    <ul>
      ...
      <div class="todo-btns">
      <button type="button" class="edit-btn" @click="updateTodo(todo._id, todo)"><span v-if="!openEdit">Edit</span><span v-else>Save</span></button>
        <button type="button" class="del-btn" @click="delTodo(todo._id, i)">Delete</button>
      </div>
      <form
        class="update-form"
        id="updateForm"
        ...
        method="post"
      >
        <input type="text" name="updateTitle" id="updateTodo" v-model="todo.title" /> <br>
        <input type="text" name="updateDescription" id="updateTodo" v-model="todo.description" />
      </form>
      </li>
    </ul>
    </div>
